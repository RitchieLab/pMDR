...
#include "detail_dynamic_bitset.hpp"
#include "iterator.hpp" // used to implement append(Iter, Iter)
#include "static_assert.hpp"
#include "limits.hpp"
#include "lowest_bit.hpp" // used by find_first/next
